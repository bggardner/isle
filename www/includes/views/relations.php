<div class="listRightCont">
  <div class="listRight">
    ...
    <table id="nodeTable" class="table table-striped<?php if($u['role'] >= ISLE\DataModels\Role::CONTRIBUTOR) { echo ' table-clickable'; } ?>">
    </table>
    </div>
  </div>
</div>
<div class="listLeft center">
  <?php if($u['role'] >= ISLE\DataModels\Role::CONTRIBUTOR) { ?>
...
<?php 
  if($u['role'] >= ISLE\DataModels\Role::CONTRIBUTOR) {
